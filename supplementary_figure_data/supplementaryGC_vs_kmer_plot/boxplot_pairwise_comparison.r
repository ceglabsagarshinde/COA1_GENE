...
#boxplot(a[,exon+2]~a$V1,main=title,xlab="Species groups", ylim=c(min(a[,exon+2],na.rm=T),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))),ylab="GC %", col="Lightsalmon",border="darksalmon",las=2,cex=3,cex.main=4,cex.axis=3,cex.lab=4)
jpeg(paste("exon",exon,".jpeg",sep=""),height=2500,width=3600)
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(a[,exon+2]~a$V1,main=title,xlab="Species groups", ylim=c(min(a[,exon+2],na.rm=T),as.numeric(maxquan)+1+(2*(length(P[P$qvalue<0.05,3])))),ylab="GC %", col="Lightsalmon",border="black",las=2,cex=4,cex.main=4,cex.axis=3,cex.lab=4,lwd=2)
...
par(mai=c(4,4,2,1),mgp=c(13,0.5,0.1))
#jpeg("exon1a.jpeg",height=2500,width=3600)
#par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
#boxplot(a$V4,main=title,xlab="Primates", ylab="GC %", col="Lightsalmon",border="darksalmon",las=2,cex=3,cex.main=4,cex.axis=3,cex.lab=4)
jpeg("exon1a.jpeg",height=2500,width=3600)
par(mai=c(5,5,2,1),mgp=c(18,0.5,0.1))
boxplot(a$V4,main=title,xlab="Primates", ylab="GC %", col="Lightsalmon",border="black",las=2,cex=4,cex.main=4,cex.axis=3,cex.lab=4,lwd=2)
dev.off()
