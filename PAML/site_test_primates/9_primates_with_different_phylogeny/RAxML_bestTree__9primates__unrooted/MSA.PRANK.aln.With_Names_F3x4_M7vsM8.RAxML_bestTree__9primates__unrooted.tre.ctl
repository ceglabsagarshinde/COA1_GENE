...
treefile = RAxML_bestTree__9primates__unrooted.tre  							* tree structure file name
outfile = MSA.PRANK.aln.With_Names.F3x4.M7vsM8.RAxML_bestTree__9primates__unrooted.tre.out											* main result file name
