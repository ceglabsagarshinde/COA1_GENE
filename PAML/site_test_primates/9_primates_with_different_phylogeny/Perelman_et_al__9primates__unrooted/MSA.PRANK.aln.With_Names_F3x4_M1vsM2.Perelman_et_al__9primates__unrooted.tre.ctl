...
treefile = Perelman_et_al__9primates__unrooted.tre  							* tree structure file name
outfile = MSA.PRANK.aln.With_Names.F3x4.M1vsM2.Perelman_et_al__9primates__unrooted.tre.out											* main result file name
