      seqfile = Suricata_suricatta2.seq.fasta * sequence data filename
     treefile = Suricata_suricatta2.seq.nwk      * tree structure file name
      outfile = Suricata_suricatta2.seq_F1x4_bneutral.out        * main result file name
