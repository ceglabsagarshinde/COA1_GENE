      seqfile = Puma_concolor2.seq.fasta * sequence data filename
     treefile = Puma_concolor2.seq.nwk      * tree structure file name
      outfile = Puma_concolor2.seq_F1x4_bneutral.out        * main result file name
