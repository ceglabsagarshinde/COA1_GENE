      seqfile = Panthera_leo2.seq.fasta * sequence data filename
     treefile = Panthera_leo2.seq.nwk      * tree structure file name
      outfile = Panthera_leo2.seq_F1x4_bneutral.out        * main result file name
