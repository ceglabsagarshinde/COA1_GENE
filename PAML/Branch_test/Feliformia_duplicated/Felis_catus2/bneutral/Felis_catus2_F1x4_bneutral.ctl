      seqfile = Felis_catus2.fasta * sequence data filename
     treefile = Felis_catus2.nwk      * tree structure file name
      outfile = Felis_catus2_F1x4_bneutral.out        * main result file name
