      seqfile = Panthera_leo2.fasta * sequence data filename
     treefile = Panthera_leo2.nwk      * tree structure file name
      outfile = Panthera_leo2_F1x4_bneutral.out        * main result file name
