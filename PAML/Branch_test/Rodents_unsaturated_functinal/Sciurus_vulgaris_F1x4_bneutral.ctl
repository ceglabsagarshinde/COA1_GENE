      seqfile = Rodents_functional_all.aln.faa * sequence data filename
     treefile = Sciurus_vulgaris.nwk      * tree structure file name
      outfile = Sciurus_vulgaris_F1x4_bneutral.out        * main result file name
