      seqfile = Vulpes_vulpes2.seq.fasta * sequence data filename
     treefile = Vulpes_vulpes2.seq.nwk      * tree structure file name
      outfile = Vulpes_vulpes2.seq_F1x4_bneutral.out        * main result file name
