      seqfile = Mirounga_leonina2.seq.fasta * sequence data filename
     treefile = Mirounga_leonina2.seq.nwk      * tree structure file name
      outfile = Mirounga_leonina2.seq_F1x4_bneutral.out        * main result file name
