      seqfile = Neovison_vison2.seq.fasta * sequence data filename
     treefile = Neovison_vison2.seq.nwk      * tree structure file name
      outfile = Neovison_vison2.seq_F1x4_bneutral.out        * main result file name
