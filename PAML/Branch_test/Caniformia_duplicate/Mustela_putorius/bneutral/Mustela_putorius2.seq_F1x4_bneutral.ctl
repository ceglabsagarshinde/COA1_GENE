      seqfile = Mustela_putorius2.seq.fasta * sequence data filename
     treefile = Mustela_putorius2.seq.nwk      * tree structure file name
      outfile = Mustela_putorius2.seq_F1x4_bneutral.out        * main result file name
