      seqfile = Ursus_maritimus2.seq.fasta * sequence data filename
     treefile = Ursus_maritimus2.seq.nwk      * tree structure file name
      outfile = Ursus_maritimus2.seq_F1x4_bneutral.out        * main result file name
