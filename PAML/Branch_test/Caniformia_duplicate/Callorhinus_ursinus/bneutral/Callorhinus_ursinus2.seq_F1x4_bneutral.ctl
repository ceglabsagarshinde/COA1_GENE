      seqfile = Callorhinus_ursinus2.seq.fasta * sequence data filename
     treefile = Callorhinus_ursinus2.seq.nwk      * tree structure file name
      outfile = Callorhinus_ursinus2.seq_F1x4_bneutral.out        * main result file name
