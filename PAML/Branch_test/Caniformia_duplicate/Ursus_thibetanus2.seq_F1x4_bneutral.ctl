      seqfile = Ursus_thibetanus2.seq.fasta * sequence data filename
     treefile = Ursus_thibetanus2.seq.nwk      * tree structure file name
      outfile = Ursus_thibetanus2.seq_F1x4_bneutral.out        * main result file name
