      seqfile = Eumetopias_jubatus2.seq.fasta * sequence data filename
     treefile = Eumetopias_jubatus2.seq.nwk      * tree structure file name
      outfile = Eumetopias_jubatus2.seq_F1x4_bneutral.out        * main result file name
