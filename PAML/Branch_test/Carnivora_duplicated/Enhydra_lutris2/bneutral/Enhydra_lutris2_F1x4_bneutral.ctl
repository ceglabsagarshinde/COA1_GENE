      seqfile = Enhydra_lutris2.aln * sequence data filename
     treefile = Enhydra_lutris2.nwk      * tree structure file name
      outfile = Enhydra_lutris2_F1x4_bneutral.out        * main result file name
