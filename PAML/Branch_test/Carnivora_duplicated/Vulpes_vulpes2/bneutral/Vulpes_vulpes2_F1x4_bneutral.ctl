      seqfile = Vulpes_vulpes2.aln * sequence data filename
     treefile = Vulpes_vulpes2.nwk      * tree structure file name
      outfile = Vulpes_vulpes2_F1x4_bneutral.out        * main result file name
