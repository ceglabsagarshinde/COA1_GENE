      seqfile = Canis_lupus2.aln * sequence data filename
     treefile = Canis_lupus2.nwk      * tree structure file name
      outfile = Canis_lupus2_F1x4_bneutral.out        * main result file name
