      seqfile = Lynx_canadensis2.aln * sequence data filename
     treefile = Lynx_canadensis2.nwk      * tree structure file name
      outfile = Lynx_canadensis2_F1x4_bneutral.out        * main result file name
