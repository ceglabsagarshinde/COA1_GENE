      seqfile = Neovison_vison2.aln * sequence data filename
     treefile = Neovison_vison2.nwk      * tree structure file name
      outfile = Neovison_vison2_F1x4_bneutral.out        * main result file name
