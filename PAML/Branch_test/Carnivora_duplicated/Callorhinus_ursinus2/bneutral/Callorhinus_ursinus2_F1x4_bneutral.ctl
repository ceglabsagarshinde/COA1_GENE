      seqfile = Callorhinus_ursinus2.aln * sequence data filename
     treefile = Callorhinus_ursinus2.nwk      * tree structure file name
      outfile = Callorhinus_ursinus2_F1x4_bneutral.out        * main result file name
