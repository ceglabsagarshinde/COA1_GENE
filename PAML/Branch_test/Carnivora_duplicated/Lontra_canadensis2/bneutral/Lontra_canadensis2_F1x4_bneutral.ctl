      seqfile = Lontra_canadensis2.aln * sequence data filename
     treefile = Lontra_canadensis2.nwk      * tree structure file name
      outfile = Lontra_canadensis2_F1x4_bneutral.out        * main result file name
