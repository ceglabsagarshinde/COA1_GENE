      seqfile = Ursus_thibetanus2.aln * sequence data filename
     treefile = Ursus_thibetanus2.nwk      * tree structure file name
      outfile = Ursus_thibetanus2_F1x4_bneutral.out        * main result file name
