      seqfile = Phoca_vitulina2.aln * sequence data filename
     treefile = Phoca_vitulina2.nwk      * tree structure file name
      outfile = Phoca_vitulina2_F1x4_bneutral.out        * main result file name
