      seqfile = Ursus_americanus2.aln * sequence data filename
     treefile = Ursus_americanus2.nwk      * tree structure file name
      outfile = Ursus_americanus2_F1x4_bneutral.out        * main result file name
