      seqfile = Ursus_maritimus2.aln * sequence data filename
     treefile = Ursus_maritimus2.nwk      * tree structure file name
      outfile = Ursus_maritimus2_F1x4_bneutral.out        * main result file name
