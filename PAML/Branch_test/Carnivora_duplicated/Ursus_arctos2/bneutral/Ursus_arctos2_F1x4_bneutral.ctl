      seqfile = Ursus_arctos2.aln * sequence data filename
     treefile = Ursus_arctos2.nwk      * tree structure file name
      outfile = Ursus_arctos2_F1x4_bneutral.out        * main result file name
