      seqfile = Leptonychotes_weddellii2.aln * sequence data filename
     treefile = Leptonychotes_weddellii2.nwk      * tree structure file name
      outfile = Leptonychotes_weddellii2_F1x4_bneutral.out        * main result file name
