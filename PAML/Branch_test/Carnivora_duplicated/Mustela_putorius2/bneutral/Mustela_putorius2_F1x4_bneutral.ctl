      seqfile = Mustela_putorius2.aln * sequence data filename
     treefile = Mustela_putorius2.nwk      * tree structure file name
      outfile = Mustela_putorius2_F1x4_bneutral.out        * main result file name
