      seqfile = Oryctolagus_cuniculus2.seq.fasta * sequence data filename
     treefile = Oryctolagus_cuniculus2.seq.nwk      * tree structure file name
      outfile = Oryctolagus_cuniculus2.seq_F1x4_bneutral.out        * main result file name
