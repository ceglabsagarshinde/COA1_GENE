      seqfile = Urocitellus_parryii2.seq.fasta * sequence data filename
     treefile = Urocitellus_parryii2.seq.nwk      * tree structure file name
      outfile = Urocitellus_parryii2.seq_F1x4_bneutral.out        * main result file name
