      seqfile = birds_functional.aln.faa * sequence data filename
     treefile = Cyanistes_caeruleus.nwk      * tree structure file name
      outfile = Cyanistes_caeruleus_F1x4_bneutral.out        * main result file name
