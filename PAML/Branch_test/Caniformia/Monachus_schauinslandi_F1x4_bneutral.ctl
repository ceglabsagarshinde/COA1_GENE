      seqfile = Monachus_schauinslandi * sequence data filename
     treefile = Monachus_schauinslandi.nwk      * tree structure file name
      outfile = Monachus_schauinslandi_F1x4_bneutral.out        * main result file name
