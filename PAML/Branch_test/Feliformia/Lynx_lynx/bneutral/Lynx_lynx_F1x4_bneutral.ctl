      seqfile = Feliformia.all_functional.fa * sequence data filename
     treefile = Lynx_lynx.nwk      * tree structure file name
      outfile = Lynx_lynx_F1x4_bneutral.out        * main result file name
