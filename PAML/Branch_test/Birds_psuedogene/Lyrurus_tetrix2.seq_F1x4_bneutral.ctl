      seqfile = Lyrurus_tetrix2.seq.fasta * sequence data filename
     treefile = Lyrurus_tetrix2.seq.nwk      * tree structure file name
      outfile = Lyrurus_tetrix2.seq_F1x4_bneutral.out        * main result file name
