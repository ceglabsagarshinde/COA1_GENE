      seqfile = Centrocercus_minimus.seq * sequence data filename
     treefile = Centrocercus_minimus.nwk      * tree structure file name
      outfile = Centrocercus_minimus_F1x4_bneutral.out        * main result file name
