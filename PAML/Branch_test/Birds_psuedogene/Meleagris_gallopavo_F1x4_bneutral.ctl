      seqfile = Meleagris_gallopavo.seq * sequence data filename
     treefile = Meleagris_gallopavo.nwk      * tree structure file name
      outfile = Meleagris_gallopavo_F1x4_bneutral.out        * main result file name
