      seqfile = Pavo_cristatus2.seq.fasta * sequence data filename
     treefile = Pavo_cristatus2.seq.nwk      * tree structure file name
      outfile = Pavo_cristatus2.seq_F1x4_bneutral.out        * main result file name
