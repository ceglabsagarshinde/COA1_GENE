      seqfile = Numida_meleagris.seq * sequence data filename
     treefile = Numida_meleagris.nwk      * tree structure file name
      outfile = Numida_meleagris_F1x4_bneutral.out        * main result file name
