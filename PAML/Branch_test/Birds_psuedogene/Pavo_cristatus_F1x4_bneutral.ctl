      seqfile = Pavo_cristatus.seq * sequence data filename
     treefile = Pavo_cristatus.nwk      * tree structure file name
      outfile = Pavo_cristatus_F1x4_bneutral.out        * main result file name
