      seqfile = Syrmaticus_mikado2.seq.fasta * sequence data filename
     treefile = Syrmaticus_mikado2.seq.nwk      * tree structure file name
      outfile = Syrmaticus_mikado2.seq_F1x4_bneutral.out        * main result file name
