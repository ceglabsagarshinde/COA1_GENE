      seqfile = Centrocercus_minimus2.seq.fasta * sequence data filename
     treefile = Centrocercus_minimus2.seq.nwk      * tree structure file name
      outfile = Centrocercus_minimus2.seq_F1x4_bneutral.out        * main result file name
