      seqfile = Afrotheria_COA1.aln.faa * sequence data filename
     treefile = Mammuthus_primigenius.nwk      * tree structure file name
      outfile = Mammuthus_primigenius_F1x4_bneutral.out        * main result file name
