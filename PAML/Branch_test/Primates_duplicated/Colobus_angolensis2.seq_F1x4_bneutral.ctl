      seqfile = Colobus_angolensis2.seq.fasta * sequence data filename
     treefile = Colobus_angolensis2.seq.nwk      * tree structure file name
      outfile = Colobus_angolensis2.seq_F1x4_bneutral.out        * main result file name
