      seqfile = Homo_sapiens2.seq.fasta * sequence data filename
     treefile = Homo_sapiens2.seq.nwk      * tree structure file name
      outfile = Homo_sapiens2.seq_F1x4_bneutral.out        * main result file name
