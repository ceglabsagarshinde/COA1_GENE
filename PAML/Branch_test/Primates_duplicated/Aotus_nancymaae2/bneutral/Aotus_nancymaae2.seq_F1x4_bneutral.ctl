      seqfile = Aotus_nancymaae2.seq.fasta * sequence data filename
     treefile = Aotus_nancymaae2.seq.nwk      * tree structure file name
      outfile = Aotus_nancymaae2.seq_F1x4_bneutral.out        * main result file name
