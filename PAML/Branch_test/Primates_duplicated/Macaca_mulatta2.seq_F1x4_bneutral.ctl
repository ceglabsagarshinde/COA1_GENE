      seqfile = Macaca_mulatta2.seq.fasta * sequence data filename
     treefile = Macaca_mulatta2.seq.nwk      * tree structure file name
      outfile = Macaca_mulatta2.seq_F1x4_bneutral.out        * main result file name
