      seqfile = Primates_Rodents.MYH4.aln * sequence data filename
     treefile = Primates_Rodents.MYH4.nwk      * tree structure file name
      outfile = Primates_Rodents.MYH4.aln_F1x4_bneutral.out        * main result file name
