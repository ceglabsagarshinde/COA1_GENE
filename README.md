...
4.Figure5 :The Figure5 folder contains the A to F folders with bam files from different bio-project IDs of woolly mammoth generated to compare reads support for COA1 gene exon sequences. The output files for the GC Vs. kmer plot are from 7 different project IDs of the woolly mammoth in the G folder. Required input files and script are provided in detail. 
